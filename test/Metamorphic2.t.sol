...
// forge script test/Metamorphic2.t.sol:DeployMetamorphic2 --private-key $KEY  --rpc-url https://rpc.ankr.com/eth_goerli -vvvv  --verify --etherscan-api-key $API --broadcast
contract DeployMetamorphic2 is Script {
  MetamorphicContractFactory public metamorphicContractFactory;
  ContractOne public c1;
  ContractTwo public c2;
...
contract MetamorphicTest2 is Test{
  MetamorphicContractFactory public metamorphicContractFactory;
  ContractOne public c1;
  ContractTwo public c2;
  ...
  function testMetamorphic() external {
    // metamorphicContractFactory = new MetamorphicContractFactory("");
